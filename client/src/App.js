...
import TeamAdminComponent from './components/admin/TeamAdminComponent';
import GamesComponent from './components/admin/GamesComponent';
          ...
          <Routes>
            ...
            <Route element={<ProtectRoutes />}>
              <Route path='/admin' element={<Admin />}>
                <Route path='' element={<TeamAdminComponent />} />                
